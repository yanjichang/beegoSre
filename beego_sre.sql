...
-- ----------------------------
--  Table structure for `sre_api_detail`
-- ----------------------------
DROP TABLE IF EXISTS `sre_api_detail`;
CREATE TABLE `sre_api_detail` (
...
-- ----------------------------
--  Records of `sre_api_source`
-- ----------------------------
BEGIN;
INSERT INTO `sre_api_source` VALUES ('1', '2', '库存', '1', '0', '1', '1', '1507616276', '1516283236', '0'), ('2', '2', '订单', '1', '0', '1', '1', '1507616329', '1516283124', '0'), ('3', '2', '商品', '1', '0', '1', '1', '1507616394', '1516283140', '0'), ('4', '1', '交易', '1', '0', '1', '1', '1507616421', '1516283245', '0'), ('5', '1', '评价', '1', '0', '1', '1', '1510122234', '1516283256', '0'), ('6', '3', '物流', '1', '0', '1', '1', '1515575836', '1516286650', '0'), ('7', '3', '订单', '0', '0', '1', '1', '1515914737', '1516281455', '0');
COMMIT;

-- ----------------------------
--  Table structure for `sre_set_code`
-- ----------------------------
DROP TABLE IF EXISTS `sre_set_code`;
CREATE TABLE `sre_set_code` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Records of `sre_set_code`
-- ----------------------------
BEGIN;
INSERT INTO `sre_set_code` VALUES ('1', '200', '返回成功', '请求成功', '1', '0', '0', '1506328003', '1506328037'), ('2', '300', '返回错误', '请求失败', '1', '0', '0', '1506328023', '1506328023'), ('3', '302', '请求成功', '错误', '0', '0', '0', '1506328070', '1506334951');
COMMIT;

-- ----------------------------
--  Table structure for `sre_set_env`
-- ----------------------------
DROP TABLE IF EXISTS `sre_set_env`;
CREATE TABLE `sre_set_env` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Records of `sre_set_env`
-- ----------------------------
BEGIN;
INSERT INTO `sre_set_env` VALUES ('1', '测试地址', 'http://test.haodaquan.com', '测试地址', '1', '0', '1', '1506316614', '1516283029'), ('2', '测试地址3', 'http://127.0.0.1:8083', '测试地址3', '0', '0', '0', '1506316696', '1506316850'), ('3', '正式环境', 'http://api.haodaquan.com', '这个也是测试内容', '1', '1', '1', '1515140110', '1516281840');
COMMIT;

-- ----------------------------
--  Table structure for `sre_set_group`
-- ----------------------------
DROP TABLE IF EXISTS `sre_set_group`;
CREATE TABLE `sre_set_group` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Records of `sre_set_group`
-- ----------------------------
BEGIN;
INSERT INTO `sre_set_group` VALUES ('1', '供应商', '这是供应商', '1,3', '1,2', '1,2,3', '1', '0', '1', '1506237536', '1516283091'), ('2', '大商户', '关于大商户的接口', '1,3', '1,2', '1,2,3', '1', '0', '1', '1506237621', '1516283080'), ('3', 'Top商户', '有关订单的接口', '1,3', '1,2', '1,2,3', '1', '1', '1', '1516281298', '1516371024');
COMMIT;

-- ----------------------------
--  Table structure for `sre_set_template`
-- ----------------------------
DROP TABLE IF EXISTS `sre_set_template`;
CREATE TABLE `sre_set_template` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Records of `sre_set_template`
-- ----------------------------
BEGIN;
INSERT INTO `sre_set_template` VALUES ('1', '接口通用模板', '#### 简要描述：\n\n- 用户登录接口\n#### 请求头：\n\n|参数名|是否必须|类型|说明|\n|:----    |:---|:----- |-----   |\n|Content-Type |是  |string |请求类型： application/json   |\n|Content-MD5 |是  |string | 请求内容签名    |\n\n\n#### 请求参数:\n\n|参数名|是否必须|类型|说明|示例值\n|:----    |:---|:----- |-----   |-----   |\n|username |是  |string |用户名   | george518\n|password |是  |string | 密码    | george518\n\n#### 返回参数:\n\n|参数名|类型|说明|\n|:-----  |:-----|-----                           |\n|group_level |int   |用户组id，1：超级管理员；2：普通用户  |\n\n#### 返回示例:\n\n**正确时返回:**\n\n```\n{\n\"status\": 200,\n\"message\": \"Success\",\n\"data\": {\n    \"uid\": \"1\",\n    \"account\": \"admin\",\n    \"nickname\": \"Minho\",\n    \"group_level\": 0 ,\n    \"create_time\": \"1436864169\",\n    \"last_login_time\": \"0\",\n}\n}\n```\n\n**错误时返回:**\n\n\n```\n{\n\"status\": 300,\n\"message\": \"invalid username\"\n\"data\":{\n    \n}\n}\n```\n\n#### 调用示例:\n\n```\n\n<?php\n    echo \"Hello world\";\n```\n#### 备注:\n\n- 更多返回错误代码请看首页的错误代码描述\n\n#### 接口版本：\n\n|版本号|制定人|制定日期|修订日期|\n|:----    |:---|:----- |-----   |\n|2.1.0 |郝大全  |2018-01-15 |  2018-01-15 |', '1', '1', '1', '1516085341', '1516281815'), ('2', '公共文档模板', '#### 这是标题\n\n- 这是内容这是一个AP管理的内容模板\n内容模板啊啊', '1', '1', '1', '1516085369', '1516281799');
COMMIT;

-- ----------------------------
--  Table structure for `sre_uc_admin`
-- ----------------------------
DROP TABLE IF EXISTS `sre_uc_admin`;
CREATE TABLE `sre_uc_admin` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Records of `sre_uc_admin`
-- ----------------------------
BEGIN;
INSERT INTO `sre_uc_admin` VALUES ('1', 'admin', '超级管理员', '840fa1e5f049c861c7ed245293afcf8d', '0', '13888888889', 'haodaquan2008@163.com', 'kmcB', '1515904905', '[', '1', '0', '0', '0', '1506128438'), ('2', 'george518', 'georgeHao', 'e5d77ebaffd5e4fe7164b31c6d7f1921', '1,2', '13811558899', '12@11.com', 'ONNy', '1506125048', '127.0.0.1', '0', '0', '0', '0', '1515116737'), ('3', 'haodaquan', '郝大全', 'e9fa9187e7497892c237433aee966cc1', '2,1', '13811559988', 'hao@123.com', '6fWE', '1505960085', '127.0.0.1', '1', '1', '0', '1505919245', '1513388240'), ('4', 'ceshizhanghao', '测试姓名', 'fa3fb5825c2e64bc764f29245dd1ec7a', '2', '13988009988', '232@124.com', 'i8Nf', '0', '', '1', '1', '0', '1506047337', '1513388111');
COMMIT;

-- ----------------------------
--  Table structure for `sre_uc_auth`
-- ----------------------------
DROP TABLE IF EXISTS `sre_uc_auth`;
CREATE TABLE `sre_uc_auth` (
...
-- ----------------------------
--  Records of `sre_uc_role`
-- ----------------------------
BEGIN;
INSERT INTO `sre_uc_role` VALUES ('1', 'API管理员', '拥有API所有权限', '0', '2', '1', '1505874156', '1505874156'), ('2', '系统管理员', '系统管理员', '0', '0', '1', '1506124114', '1506124114');
COMMIT;

-- ----------------------------
--  Table structure for `sre_uc_role_auth`
-- ----------------------------
DROP TABLE IF EXISTS `sre_uc_role_auth`;
CREATE TABLE `sre_uc_role_auth` (
...
-- ----------------------------
--  Records of `sre_uc_role_auth`
-- ----------------------------
BEGIN;
INSERT INTO `sre_uc_role_auth` VALUES ('1', '16'), ('1', '17'), ('1', '18'), ('1', '19'), ('2', '0'), ('2', '1'), ('2', '15'), ('2', '20'), ('2', '21'), ('2', '22'), ('2', '23'), ('2', '24');
COMMIT;
